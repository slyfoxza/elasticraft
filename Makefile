...
all: api_authorizer.zip discord_webhook_notification.py.zip invoke_route53ctl.py.zip python_dependency_layer.zip server_get.py.zip server_post.py.zip snapshot_on_shutdown.py.zip

clean:
	$(RM) api_authorizer.zip discord_webhook_notification.py.zip invoke_route53ctl.py.zip python_dependency_layer.zip server_get.py.zip server_post.py.zip snapshot_on_shutdown.py.zip
